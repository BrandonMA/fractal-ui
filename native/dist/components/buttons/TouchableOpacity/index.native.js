...
var StyledTouchableOpacity = styled(Reanimated.createAnimatedComponent(RNTouchableOpacity))(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n    ", ";\n    ", ";\n    ", ";\n    ", ";\n    ", ";\n"], ["\n    ", ";\n    ", ";\n    ", ";\n    ", ";\n    ", ";\n"])), extractBackgroundProps, extractDimensionProps, extractDisplayProps, extractBorderProps, extractShadowProps);
export var TouchableOpacity = forwardRef(function (_a, ref) {
    ...
    return React.createElement(StyledTouchableOpacity, __assign({ ref: ref, style: [animationStyles, style] }, others));
});
