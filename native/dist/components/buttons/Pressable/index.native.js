...
export var Pressable = forwardRef(function (_a, ref) {
    ...
    return (React.createElement(StyledPressable, __assign({ ref: ref, onPressIn: handlePressIn, onPressOut: handlePressOut, style: [tapStyles, animationStyles, style] }, others)));
});
