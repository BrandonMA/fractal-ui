...
export function AudioProgressBar(_a) {
    var _this = this;
    var duration = _a.duration, currentTime = _a.currentTime, isPlaying = _a.isPlaying, onTimeUpdate = _a.onTimeUpdate;
    var _b = useState(0), trackProgress = _b[0], setTrackProgress = _b[1];
    var _c = useState(false), isDragging = _c[0], setIsDragging = _c[1];
    var handleSlidingStart = useCallback(function () {
        setIsDragging(true);
    }, []);
    var handleValueChange = useCallback(function (positionMillis) {
        setTrackProgress(positionMillis);
    }, []);
    var handleSlidingComplete = useCallback(function (time) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, onTimeUpdate(time)];
                case 1:
                    _a.sent();
                    setIsDragging(false);
                    return [2 /*return*/];
