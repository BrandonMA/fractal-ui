...
export function GoogleButton(props: Omit<InternalButtonProps, 'textColor' | 'backgroundColor' | 'shadow' | 'children'>): JSX.Element {
    const containerColor = useThemeColor('containerColor');
    return (
        <InternalButton {...props} textColor={white.base} backgroundColor={containerColor.base} shadow={containerColor.shadow}>
