...
export function PickerButton(_a) {
    ...
    return (React.createElement(TouchableOpacity, __assign({ flexDirection: 'row', justifyContent: 'center', paddingLeft: spacings.s, paddingRight: spacings.s, borderRadius: borderRadius.s, height: sizes.textFieldHeight, backgroundColor: colors.textField }, others),
