...
export function OptionsMenuButton({ options, onOptionPress, customIcon }) {
    ...
    return (React.createElement(Popover, { placement: 'bottom', active: optionsVisible, onRequestClose: hideOptions, popoverChildren: renderMenu },
        React.createElement(CircularIconButton, { variant: 'content', reduceColor: true, onPress: toggleOptions }, customIcon
            ? customIcon
