...
import { TabBarConfigProvider } from './TabBar';
...
export function TabNavigator(props) {
    var defaultRoute = props.defaultRoute, tabBar = props.tabBar, tabBarConfig = props.tabBarConfig, children = props.children, others = __rest(props, ["defaultRoute", "tabBar", "tabBarConfig", "children"]);
