...
var Container = styled(View)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n    flex-direction: row;\n    justify-content: space-between;\n    height: ", "px;\n    background-color: ", ";\n    box-shadow: 0 1px 4px rgba(0, 0, 0, 0.08);\n    position: absolute;\n    top: 0;\n    width: 100%;\n    z-index: 1000;\n"], ["\n    flex-direction: row;\n    justify-content: space-between;\n    height: ", "px;\n    background-color: ", ";\n    box-shadow: 0 1px 4px rgba(0, 0, 0, 0.08);\n    position: absolute;\n    top: 0;\n    width: 100%;\n    z-index: 1000;\n"])), NAVIGATION_BAR_HEIGHT, function (props) { var _a; return (_a = props.backgroundColor) !== null && _a !== void 0 ? _a : '#ffffff'; });
...
export function NavigationBar(props) {
    var _a;
    var hidden = props.hidden, title = props.title, hideBackButton = props.hideBackButton, children = props.children;
    var navigationBarInsets = useContext(NavigationBarInsetsContext);
    var history = useHistory();
    var _b = useMatch('/'), activeRoutes = _b[1];
    var styleProps = createNavigationBarStyleProps(props);
    ...
    return hidden ? null : (React.createElement(Container, __assign({}, styleProps),
