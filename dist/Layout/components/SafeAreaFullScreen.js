...
import { getInsetsStyle } from '../util/getInsetsStyle';
...
var insetsStyleConfig = { type: 'padding', removeHorinzontal: true };
export function SafeAreaFullScreen(props) {
    var totalInsets = useNavigationInsets().totalInsets;
    return React.createElement(Container, __assign({}, props, { insets: totalInsets, insetsStyleConfig: insetsStyleConfig }));
}
