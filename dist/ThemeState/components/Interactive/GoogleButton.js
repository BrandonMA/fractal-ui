...
function GoogleIcon(props) {
    return (React.createElement(Svg, __assign({ viewBox: '0 0 48 48', width: 96, height: 96 }, props),
...
export function GoogleButton(props) {
    ...
    return (React.createElement(InternalButton, __assign({}, props, { textColor: white.base, backgroundColor: containerColor.base, shadow: containerColor.shadow }),
